...
#Camera Design with HTML and CSS

This project presents a simple Camera Design created using HTML and CSS. The purpose is to showcase a visually appealing representation of a camera interface, which can be used in web development projects or UI mockups.
## Demo

Insert gif or link to demo

![Alt Text](https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExaHlxNnNzZ2JwbndjaXJqYnpwdTllbDZ2YmttcGh4dGVsMzF6bGtocyZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/oB6XSmiKfvOSooSJj2/source.gif)

## Deployment

[Link to Deployed Application](https://dev-bhoomi.github.io/Css_Project-29/)
